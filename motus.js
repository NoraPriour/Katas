...
function guess() {
  ...
  let result = tryWord(word, base);
  if (result != true) {
    // ajout d'une vérification tryWord() != true
    document.getElementById("word").value = "";
    document.getElementById("try").innerText = word;
    ...
    // changement de la condition de victoire et de l'affichage en cas de victoire
    document.getElementById("word").value = "";
    document.getElementById("try").innerText = word;
    document.getElementById("well").innerText = "";
    document.getElementById("miss").innerText = "";
...
} // ajout bd'un croisillon fermant manquant
